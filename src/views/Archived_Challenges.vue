<template>
    <div>
        <Navbar/>
        <section class="section-header pb-4 pb-lg-3 mb-0 mb-lg-2 text-white" style="background-image:linear-gradient(to top, #f45c43, #dde0e2, #ffffff);">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 text-center">
                        <p class="mb-5 opensansfont dis-2">ARCHIVED CHALLENGES</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 card-group">
                        ...
                        <div class="card animate-up-3 mt-5" style="border-radius:15px;">
                            ...
                            <div class="card-body bg-white" style="border-radius:0 0 15px 15px;box-shadow: 0 15px 12px rgba(0, 0, 0, 0.2)">
                                ...
                                <p class="text-black nunitofont pt-3 font-weight-bolder"><i class="fas fa-trophy text-brown"></i>&nbsp;US$5,000</p>
                            </div>
                        </div>
                    <!-- </div> -->
                    </div>
