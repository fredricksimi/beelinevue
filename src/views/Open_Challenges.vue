<template>
    <div>
        <Navbar/>
        <section class="section-header pb-4 pb-lg-3 mb-0 mb-lg-2 text-white" style="background-image:linear-gradient(to top, #58d68d, #dde0e2, #ffffff);">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 text-center">
                        <p class="mb-5 opensansfont dis-2">OPEN CHALLENGES</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="pr-4 pl-4 pb-5 mt--2">
                                ...
                                <a href="" class="small" style="background-color: #d1f2ff; padding: 4px 10px; border-radius:5px"></a>
                                </li>
                            </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="pr-4 pl-4 pb-5 mt--2">
                                ...
                                <li class ="list-inline-item pb-2">
                                <a href="" class="small text-white" style="background-color: #9461c1; padding: 4px 10px; border-radius:5px">#</a>
                                </li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 card-group">
                        ...
                        <div class="card animate-up-3 mt-5" style="border-radius:15px;">
                            <div class="date" style="background-color:#EE5050; padding:2px 4px; border-radius:5px;position: absolute;top: 14px;left:16px;">
                                ...
                                <span class="day nunitofont font-weight-bolder text-white">3&nbsp;months left</span>
                            ...
                            <div class="card-body bg-white" style="border-radius:0 0 15px 15px;box-shadow: 0 15px 12px rgba(0, 0, 0, 0.2)">
                                <p><span class="author text-black nunitofont font-weight-bolder">China Shanghai International …</span>
                                ...
                                <p class="text-black pt-3 nunitofont font-weight-bolder"><i class="fas fa-trophy text-brown"></i>&nbsp;US$5,000</p>
                            </div>
                        </div>
                    <!-- </div> -->
                    </div>
